...
class Mageaustralia_Fpc_Helper_Data extends Mage_Core_Helper_Abstract
{
     ...
     *
     * Examples:
     *   example/pickleball-paddles.html           (base URL)
     *   example/pickleball-paddles__p-2.html      (page 2)
     *   example/pickleball-paddles__g1.html       (customer group 1)
     *   example/index.html                        (homepage)
     */
