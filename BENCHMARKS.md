...
|---|---|---|---|
| **dev.example.com** | Maho + nginx + PHP-FPM 8.3 + FPC (nginx `try_files` static bypass) | Dedicated, Sydney AU | 8.3 |
...
### www.example.com (live, OpenMage + Lesti FPC)
...
ab -n 200 -c 50 -H "Host: dev.example.com" http://127.0.0.1/racquets.html
```
